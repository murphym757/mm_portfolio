                        ...
                        <div class="row"> {/* Description (Left Side of Page) & Carousel (Right Side of Page) (Lines 50-87) */}
                            ...
                            <div class="col-sm-6 contactSection"> {/* Carousel Section (Lines 61-88) */}
                                <div class="container-fluid pb-2">
                                    <div class="container">
                                        <div id="cfBlogCarousel" class="carousel slide" data-ride="carousel">
                                            <ol class="carousel-indicators">
                                                <li data-target="#cfBlogCarousel" data-slide-to="0" class="active"></li>
                                                <li data-target="#cfBlogCarousel" data-slide-to="1"></li>
                                            </ol>
                                            ...
                                            <a class="carousel-control-prev" href="#cfBlogCarousel" role="button" data-slide="prev">
                                                <span aria-hidden="true"><i class="fas fa-chevron-left fa-2x"></i></span>
                                                <span class="sr-only">Previous</span>
                                            </a>
                                            <a class="carousel-control-next" href="#cfBlogCarousel" role="button" data-slide="next">
